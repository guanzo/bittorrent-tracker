...
class WebSocketTracker extends Tracker {
  ...
  announce (opts) {
    ...
    const params = Object.assign({}, opts, {
      ...
      announce_id: common.hexToBinary(randombytes(20).toString('hex'))
    })
    ...
    if (opts.event === 'stopped' || opts.event === 'completed') {
      ...
      this._generateTrickleOffers(numwant, offer => {
        let offerParams = Object.assign({}, params)
        offerParams.numwant = 1
        offerParams.offers = [offer]
        if (offer.offer.candidate) {
            // If offer was sent to peer, the trickled candidates
            offerParams.numwant = 0
  ...
  _generateTrickleOffers (numwant, cb) {
    const self = this
